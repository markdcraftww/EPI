	...
	<div class="section" data-anchor="<?php echo(basename(get_permalink())); ?>">
		<div class="grid">
			<div class="col-10-12 nopad">
				...
				<div class="grid">
					<div class="col-1-1" id="cat_desc"><?php echo term_description('41','partner_tx'); ?></div>
				</div>
			...
			<div class="related col-1-6" id="desktopfilters">
				<ul class="filterList">
					<li class="children"><button href="#filter" data-desc="<?php echo term_description('41','partner_tx'); ?>" data-filter="*" class="filterer activeFilter">SHOW ALL</button></li>
					<?php
						$args = array(
							'orderby'            => 'ID',
							'order'              => 'ASC',
